...
def capture_image():
    ...
    # Creating the dedicated folder if it doesn't exist
...
captureButton = ttk.Button(
    captureBFrame, text="Capture Image", command=capture_image)
...
browseButton = ttk.Button(
    inputFrame, text="Browse Image", command=browse_image)
